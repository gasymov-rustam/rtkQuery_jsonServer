...
export const withQueryResolver =
  ...
  <TComponentProps,>(
    Component: FC<WithQueryResolverData<typeof useQuery> & TQueryArg & TComponentProps>
  ) =>
  (
    ...
    const { queryArg, containsError, disableLoading, containsFetching, onRefetch, ...otherProps } =
      props;
    const {
      data,
...
export const withOtherQueryResolver =
  ...
  <TComponentProps, TOtherQueryArg>(
    Component: FC<PrivateResolverProps & ResolverProps<TOtherQueryArg> & TComponentProps>
  ) =>
...
export const withMutationResolver =
  ...
  <TComponentProps,>(
    Component: FC<WithMutationResolverProps<typeof useMutation> & TComponentProps>
  ) =>
  (
    props: MutationResolverProps &
      Omit<TComponentProps, keyof WithMutationResolverProps<typeof useMutation>>
  ) => {
